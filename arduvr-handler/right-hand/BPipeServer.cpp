...
int main(int argc, char* argv[]) {
	...
	for (;;) {
		...
		if (true) {
			...
			HANDLE hPipe = CreateFile("\\\\.\\pipe\\LogPipeIchiButton",
		...
		if (true) {
			...
			HANDLE hPipe = CreateFile("\\\\.\\pipe\\LogPipeIchiRot",
				GENERIC_READ | GENERIC_WRITE,
				0,
				NULL,
				OPEN_EXISTING,
		...
		if (true) {
			...
			HANDLE hPipe = CreateFile("\\\\.\\pipe\\LogPipeIchiFinger",
				GENERIC_READ | GENERIC_WRITE,
				0,
				NULL,
				OPEN_EXISTING,
